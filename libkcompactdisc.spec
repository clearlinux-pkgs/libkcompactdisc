...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/libkcompactdisc-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/libkcompactdisc-22.12.2.tar.xz.sig
...
%prep
%setup -q -n libkcompactdisc-22.12.2
cd %{_builddir}/libkcompactdisc-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675640119
mkdir -p clr-build
pushd clr-build
