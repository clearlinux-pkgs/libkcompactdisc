...
Version  : 21.08.3
Release  : 32
URL      : https://download.kde.org/stable/release-service/21.08.3/src/libkcompactdisc-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/libkcompactdisc-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/libkcompactdisc-21.08.3.tar.xz.sig
...
%prep
%setup -q -n libkcompactdisc-21.08.3
cd %{_builddir}/libkcompactdisc-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636050803
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkcompactdisc-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/libkcompactdisc/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/libkcompactdisc-21.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkcompactdisc/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
