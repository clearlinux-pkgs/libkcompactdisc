...
Version  : 25.04.2
Release  : 81
URL      : https://download.kde.org/stable/release-service/25.04.2/src/libkcompactdisc-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/libkcompactdisc-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/libkcompactdisc-25.04.2.tar.xz.sig
...
%setup -q -n libkcompactdisc-25.04.2
cd %{_builddir}/libkcompactdisc-25.04.2
pushd ..
cp -a libkcompactdisc-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749488722
mkdir -p clr-build
pushd clr-build
