...
Source0  : https://download.kde.org/stable/applications/18.12.3/src/libkcompactdisc-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/libkcompactdisc-18.12.3.tar.xz.sig
...
%prep
%setup -q -n libkcompactdisc-18.12.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1555353744
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
